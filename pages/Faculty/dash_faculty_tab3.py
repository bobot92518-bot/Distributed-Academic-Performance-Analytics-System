...
def compute_subject_failure_rates(passing_grade: int = 75, selected_semester_id = None):
    """
...
def show_faculty_tab3_info():
        ...
        df = compute_subject_failure_rates(passing_grade=passing_grade, selected_semester_id=selected_semester_id)
